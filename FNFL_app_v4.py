...
with tab_waivers:
    ...
    if df_free_agents.empty and league_config:
        ...
        # --- NEW SIDE-BY-SIDE WAIVER LAYOUT ---
        ...
        with col_plot:
            ...
            # UPGRADE: Add calculated columns to raw weekly so they can be plotted on axes
            ...
            if not df_fa_raw_weekly.empty:
                # UPGRADE: Dynamically group and aggregate on the SELECTED scouting metric
